...
class AgentResponseTemplates:
    ...
    def __init__(self):
        ...
        self._substitution_options = {
            ...
            "agreement_level": ["agree", "disagree", "partially agree", "strongly agree", "somewhat disagree"],
            "concern_level": ["concerned", "satisfied", "very concerned", "moderately concerned", "pleased", "worried"],
